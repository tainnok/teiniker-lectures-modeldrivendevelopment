...
public class EntityValidator implements EntityVisitor {
	private static final List<String> KEY_WORDS = Arrays.asList("abstract", "assert", "boolean", "break", "byte",
	...
	public void visit(MEntity entity) {
		if (KEY_WORDS.contains(entity.getName()))
			throw new IllegalStateException("MEntity.name is a keyword: " + entity.getName());
