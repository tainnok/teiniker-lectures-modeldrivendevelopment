...
public class VelocityTest {
	...
	@Before
	public void setup() {
		pkg = new PackageBuilder("org.se.lab").iface("Stack").isPublic().operation("push").asVoid().parameter("value")
				.asInt().operation("pop").asInt().operation("top").asInt().operation("isEmpty").asBoolean()
				.operation("isFull").asBoolean().toPackage();
		...
		// TODO: Mehrere Interfaces möglich - hier oder im Template über die Liste
		// iterieren
